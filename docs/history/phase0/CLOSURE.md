...
The concise current capability and artifact inventory is maintained in
...
| C0-05 local serve/operator smoke | Completed | [Local development runbook](../../operations/local-development.md), localhost central API, one active project-orchestrator lease, rendered six-column board, and browser smoke with no console warnings |
...
Phase 0 is complete for the local-smoke profile. The
[roadmap](../../product/ROADMAP.md) is now the canonical sequence: Phase 1
local cockpit, Phase 2 autonomy/recovery/portability, and Phase 3
