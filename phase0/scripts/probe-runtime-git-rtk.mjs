...
const image = process.argv[3] ?? "boss-man-phase0:pi-0.80.9-rtk-0.42.3";
...
await cp(join(repositoryRoot, "phase0/runtime/rtk-config.toml"), join(rtkConfigDirectory, "config.toml"));
