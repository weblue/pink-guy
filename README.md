...
This repository contains the planning baseline and executable Phase 0 feasibility work for Boss Man v2. The production application has not started; current code is limited to deterministic fixtures, Pi lifecycle/custody probes, adapter contract tests, and evidence manifests used to select the foundation.
