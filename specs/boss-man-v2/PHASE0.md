...
| P0-02 Direct Pi | Integrated through C0-03 | Daemon/store/board/Pi RPC/shell/events/custody, task policy, runtime/Git/credentials/RTK, and active side-effect reconciliation pass; unified context and production auth remain |
...
| P0-04 Runtime/Git/RTK | Integrated pass | Pinned ARM64 image, restricted mounts, host checkpoint, run-scoped synthetic credential isolation, and RTK raw/redacted evidence pass through the selected daemon |
