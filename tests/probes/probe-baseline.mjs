...
const fixtureScript = join(scriptDirectory, "../support/create-fixture.sh");
const runner = join(scriptDirectory, "../support/run-evidence-command.mjs");
...
const checksumLines = (await readFile(join(repositoryRoot, "tests/fixtures/fixture-checksums.sha256"), "utf8"))
  .trim().split("\n");
...
const sourceManifest = JSON.parse(await readFile(join(repositoryRoot, "tests/evidence/phase0/source-manifest.json"), "utf8"));
